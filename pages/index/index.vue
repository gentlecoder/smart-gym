			...
			<view @tap="goToGameDetail(index)" class="cosmos-chat text-grey" v-for="(item, index) in cosmosList"
				...
				<view class="padding-lr-xls" @tap.stop="">
					...
					<view :class="['grid', 'margin-auto']" v-if="item.videoUrl">
						<!-- <view class="margin-tb-sm cosmos-image-item"> -->
							<!-- 							<video id="myVideo"
								src="https://img.cdn.aliyun.dcloud.net.cn/guide/uniapp/%E7%AC%AC1%E8%AE%B2%EF%BC%88uni-app%E4%BA%A7%E5%93%81%E4%BB%8B%E7%BB%8D%EF%BC%89-%20DCloud%E5%AE%98%E6%96%B9%E8%A7%86%E9%A2%91%E6%95%99%E7%A8%8B@20200317.mp4"
								@error="videoErrorCallback" controls></video> -->
							<!-- <video style="z-index: 999;" id="myVideo" :src="item.videoUrl"
								@error="videoErrorCallback" controls></video> -->
							<video id="myVideo" src="http://vjs.zencdn.net/v/oceans.mp4" @error="videoErrorCallback"
								controls></video>
						<!-- </view> -->
					</view>
				</view>
